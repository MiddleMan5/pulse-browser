...
${chalk.whiteBright.bgGreen.bold("npm uninstall --save your-package")}
 ${chalk.bold('Then, instead of installing the package to the root "./package.json":')}
${chalk.whiteBright.bgRed.bold("npm install --save your-package")}
 ${chalk.bold('Install the package to "./src/package.json"')}
${chalk.whiteBright.bgGreen.bold("cd ./app && npm install --save add your-package")}
