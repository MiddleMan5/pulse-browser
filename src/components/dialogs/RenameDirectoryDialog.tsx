...
class RenameDirectoryDialog extends React.Component<Props, State> {
    state = {
        ...
        name: this.props.selectedDirectoryPath
            ? extractDirectoryName(this.props.selectedDirectoryPath, PlatformIO.getDirSeparator())
            : "",
    };
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <DialogActions>
                    <Button data-tid="closeRenameDirectoryDialog" onClick={this.props.onClose} color="primary">
                        {i18n.t("core:cancel")}
                    </Button>
                    <Button
