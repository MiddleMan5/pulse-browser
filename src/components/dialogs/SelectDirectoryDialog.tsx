...
class SelectDirectoryDialog extends React.Component<Props, State> {
    ...
    onBackButton = () => {
        const lastIndex = this.state.currentPath.lastIndexOf(PlatformIO.getDirSeparator());
    ...
    renderDriveSuggestions = (drive) => (
        <div className={styles.buttonContainer}>
            <Button key={drive.name} onClick={(e) => this.handleChooseDrive(e, drive.path)}>
                <FolderIcon />
        ...
        return (
            ...
            >
                ...
                <DialogContent>
                    ...
                    <FormControl fullWidth={true}>
                        <Paper elevation={2}>
                            <Button data-tid="onBackButtonSelectDirectoryDialog" onClick={() => this.onBackButton()}>
                                <UndoIcon />
                            </Button>
                            <Button
                ...
                <DialogActions>
                    ...
                    <Button onClick={this.onConfirm} data-tid="confirmSelectDirectoryDialog" color="primary">
                        {i18n.t("core:ok")}
                    </Button>
                </DialogActions>
            </Dialog>
