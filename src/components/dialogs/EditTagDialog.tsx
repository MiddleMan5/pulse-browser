        ...
        return (
            ...
            >
                ...
                <DialogContent style={{ overflow: "visible" }}>
                    <FormControl fullWidth={true} error={this.state.inputError} style={{ overflow: "visible" }}>
                        {modifiedDate && (
                            <div
                                className="tag-date"
                                style={{
                        ...
                        {this.state.inputError && (
                            <FormHelperText style={styles.helpText}>{i18n.t("core:tagTitleHelper")}</FormHelperText>
                        )}
                    </FormControl>
                ...
                <DialogActions>
                    <Button onClick={this.props.onClose} data-tid="closeEditTagDialog" color="primary">
                        {i18n.t("core:cancel")}
                    </Button>
                    <Button
