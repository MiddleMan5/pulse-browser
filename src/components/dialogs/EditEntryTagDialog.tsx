...
const EditEntryTagDialog = (props: Props) => {
    ...
    function renderActions() {
        return (
            <DialogActions>
                <Button data-tid="closeEditTagEntryDialog" onClick={props.onClose} color="primary">
                    {i18n.t("core:cancel")}
                </Button>
                <Button
...
export default withMobileDialog()(withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(EditEntryTagDialog)));
