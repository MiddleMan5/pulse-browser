...
const CreateDialog = (props: Props) => {
    ...
    const fileName =
        "note" + AppConfig.beginTagContainer + formatDateTime4Tag(new Date(), true) + AppConfig.endTagContainer;
    const fileContent = "";
    ...
    function handleFileInputChange(selection: any) {
        ...
        props.resetProgress();
        props
            .uploadFilesAPI(Array.from(selection.currentTarget.files), selectedDirectoryPath, props.onUploadProgress)
            .then((fsEntries) => {
    ...
    return (
        ...
        >
            <DialogTitle style={{ alignSelf: "center" }}>{i18n.t("createNewContent")}</DialogTitle>
            ...
            <DialogActions style={{ alignSelf: "center" }}>
                <Button data-tid="closeKeyboardDialog" onClick={onClose} color="primary">
                    {i18n.t("core:close")}
                </Button>
            </DialogActions>
        </Dialog>
...
export default connect(mapStateToProps, mapActionCreatorsToProps)(withMobileDialog()(withStyles(styles)(CreateDialog)));
