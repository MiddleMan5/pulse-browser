                        ...
                        endAdornment={
                            PlatformIO.haveObjectStoreSupport() || AppConfig.isWeb ? undefined : (
                                <InputAdornment position="end" style={{ height: 33 }}>
                                    <IconButton data-tid="openDirectoryMoveCopyDialog" onClick={selectDirectory}>
                                        <FolderIcon />
                                    </IconButton>
                                </InputAdornment>
                            )
...
export default connect(null, mapActionCreatorsToProps)(withMobileDialog()(MoveCopyFilesDialog));
