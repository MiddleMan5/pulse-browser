            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                    <FormControl fullWidth={true} error={state.cloudErrorSecretAccessKey}>
                        ...
                        {state.cloudErrorSecretAccessKey && (
                            <FormHelperText>{i18n.t("core:invalidSecretAccessKey")}</FormHelperText>
                        )}
                    </FormControl>
                </Grid>
                <Grid item xs={12}>
                    <FormControl fullWidth={true} error={state.cloudErrorBucketName}>
                        ...
                        {state.cloudErrorBucketName && (
                            <FormHelperText>{i18n.t("core:invalidBucketName")}</FormHelperText>
                        )}
                    </FormControl>
                </Grid>
                <Grid item xs={12}>
                    <FormControl fullWidth={true} error={state.cloudErrorRegion}>
                        <Autocomplete
                            ...
                            renderInput={(params) => (
                                <TextField {...params} label={i18n.t("core:regionSearch")} margin="normal" />
                            )}
                        />
                ...
                <Grid item xs={12}>
                    <FormControl fullWidth={true}>
                        <InputLabel htmlFor="endpointURL">{i18n.t("core:endpointURL")}</InputLabel>
                        <Input
                            margin="dense"
                            name="endpointURL"
                            fullWidth={true}
