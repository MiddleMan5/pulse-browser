...
interface Props {
    setTagBackgroundColor: (tagColor: string) => void;
            ...
            <List className={classes.root}>
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <Select
                        ...
                        onChange={(event: any) => this.props.setCurrentTheme(event.target.value)}
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <Switch
                        ...
                        onClick={() =>
                            this.props.setPersistTagsInSidecarFile(!this.props.settings.persistTagsInSidecarFile)
                        }
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <Switch
                        ...
                        onClick={() => this.props.setAddTagsToLibrary(!this.props.settings.addTagsToLibrary)}
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <Switch
                        ...
                        onClick={() => this.props.setUseGenerateThumbnails(!this.props.settings.useGenerateThumbnails)}
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <ColorPickerDialog
                        ...
                        setColor={(color) => {
                            this.props.setTagBackgroundColor(color);
                        }}
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <Switch
                        ...
                        onClick={() => this.props.setUseTrashCan(!this.props.settings.useTrashCan)}
                ...
                <ListItem className={classes.listItem}>
                    ...
                    <Switch
                        ...
                        onClick={() => this.props.setDesktopMode(!this.props.settings.desktopMode)}
