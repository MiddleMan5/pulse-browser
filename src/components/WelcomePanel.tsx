...
import { isFirstRun, getDesktopMode, actions as SettingsActions } from "../reducers/settings";
...
const WelcomePanel = (props: Props) => {
    const { classes, openURLExternally, openFileNatively, toggleKeysDialog, isDesktopMode } = props;
    return (
        <div className={classes.mainPanel}>
            ...
            <List dense={false} component="nav" aria-label="main help area" className={classes.links}>
                ...
                <ListItem button onClick={() => openURLExternally(AppConfig.links.changelogURL)}>
                    <Button startIcon={<ChangeLogIcon />} title="Opens the changelog of the app">
...
export default connect(mapStateToProps, mapActionCreatorsToProps)(withStyles(styles)(WelcomePanel));
