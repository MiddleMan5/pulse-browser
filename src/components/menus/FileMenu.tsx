    ...
    function openFile() {
        ...
        if (props.selectedFilePath) {
            getAllPropertiesPromise(props.selectedFilePath)
                ...
                .catch((error) =>
                    console.warn("Error getting properties for entry: " + props.selectedFilePath + " - " + error)
                );
        }
    }
        ...
        <div style={{ overflowY: "hidden" }}>
            <Menu anchorEl={props.anchorEl} open={props.open} onClose={props.onClose}>
                ...
                {!(PlatformIO.haveObjectStoreSupport() || AppConfig.isWeb) && (
                    <div>
                        <MenuItem data-tid="fileMenuOpenFileNatively" onClick={openFileNatively}>
                            <ListItemIcon>
                                <OpenFileNatively />
                            </ListItemIcon>
                            <ListItemText primary={i18n.t("core:openFileNatively")} />
                        </MenuItem>
                        <MenuItem data-tid="fileMenuOpenContainingFolder" onClick={showInFileManager}>
                            <ListItemIcon>
                ...
                {!props.isReadOnlyMode && (
                    <div>
                        <Divider />
                        <MenuItem data-tid="fileMenuAddRemoveTags" onClick={showAddRemoveTagsDialog}>
                            <ListItemIcon>
                                <AddRemoveTags />
                            </ListItemIcon>
                            <ListItemText primary={i18n.t("core:addRemoveTags")} />
                        </MenuItem>
                        <MenuItem data-tid="fileMenuRenameFile" onClick={showRenameFileDialog}>
                            <ListItemIcon>
                                <RenameFile />
                            </ListItemIcon>
                            <ListItemText primary={i18n.t("core:renameFile")} />
                        </MenuItem>
                        <MenuItem data-tid="fileMenuMoveCopyFile" onClick={showMoveCopyFilesDialog}>
                            <ListItemIcon>
                                <MoveCopy />
                            </ListItemIcon>
