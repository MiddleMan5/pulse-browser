...
import { extractFileName, normalizePath, cleanTrailingDirSeparator } from "../utils/paths";
...
interface Props {
    ...
    resetProgress: () => void;
    addTags: (paths: Array<string>, tags: Array<Tag>, updateIndex: boolean) => void;
}
...
const DirectoryMenu = (props: Props) => {
    ...
    function showProperties() {
        ...
        getAllPropertiesPromise(props.directoryPath)
            ...
            .catch((error) =>
                console.warn("Error getting properties for entry: " + props.directoryPath + " - " + error)
            );
    }
    ...
    function switchPerspective(perspectiveId) {
        ...
        if (Pro) {
            ...
            props.showNotification("Perspectives are part of PulseBrowser PRO", "default", true);
        }
    }
...
Do you want to continue?`)
    ...
    function moveFile(filePath) {
        const fileName =
            ...
            ".jpg";
        const newFilePath = normalizePath(props.directoryPath) + PlatformIO.getDirSeparator() + fileName;

        PlatformIO.renameFilePromise(filePath, newFilePath)
            .then(() => {
                props.showNotification("File " + newFilePath + " successfully imported.", "default", true);
            ...
            .catch((error) => {
                ...
                props.showNotification("Importing file " + newFilePath + " failed.", "error", true);
                return true;
            });
    }
    ...
    function handleFileInputChange(selection: any) {
        ...
        props
            .uploadFilesAPI(Array.from(selection.currentTarget.files), props.directoryPath, props.onUploadProgress)
            .then((fsEntries) => {
    ...
    function getDirPath(dirPath: string) {
        ...
        return props.directoryPath && fileName ? fileName : cleanTrailingDirSeparator(props.directoryPath);
    }
        ...
        <div style={{ overflowY: "hidden" }}>
            ...
            <Menu anchorEl={props.anchorEl} open={props.open} onClose={props.onClose}>
                ...
                {!props.isReadOnlyMode && (
                    <MenuItem data-tid="renameDirectory" onClick={showRenameDirectoryDialog}>
                        <ListItemIcon>
                            <RenameFolderIcon />
                        </ListItemIcon>
                ...
                {!props.isReadOnlyMode && (
                    <MenuItem data-tid="deleteDirectory" onClick={showDeleteDirectoryDialog}>
                        <ListItemIcon>
                            <DeleteForeverIcon />
                        </ListItemIcon>
                ...
                {!props.isReadOnlyMode && !props.perspectiveMode && (
                    <MenuItem data-tid="newSubDirectory" onClick={showCreateDirectoryDialog}>
                        <ListItemIcon>
                            <NewFolderIcon />
                        </ListItemIcon>
