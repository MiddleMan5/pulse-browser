            ...
            >
                ...
                >
                    ...
                    {this.props.locations.map((location: Location) => (
                        ...
                        >
                            <ListItemIcon>
                                {location.type === locationType.TYPE_CLOUD ? <CloudLocationIcon /> : <LocationIcon />}
                            </ListItemIcon>
...
export default connect(mapStateToProps, mapActionCreatorsToProps)(withTheme(LocationMenu));
