...
export const actions = {
    addLocation: (location: Location, openAfterCreate: boolean = true) => (dispatch: (actions: Object) => void) => {
    ...
    editLocation: (location: Location) => (dispatch: (actions: Object) => void) => {
    ...
    removeLocation: (location: Location) => (dispatch: (actions: Object) => void) => {
